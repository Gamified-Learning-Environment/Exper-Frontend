// Achievement Popup Component for displaying achievements when they are unlocked by the user
...
export default function AchievementPopup({ achievement, onClose }: AchievementPopupProps) {
    console.log('Rendering AchievementPopup with:', achievement);

    return (
        <motion.div // Framer Motion for animation
            initial={{ x: 300, opacity: 0 }} // Initial position and opacity
            animate={{ x: 0, opacity: 1 }} // Animate to this position and opacity
            exit={{ x: 300, opacity: 0 }} // Exit position and opacity
